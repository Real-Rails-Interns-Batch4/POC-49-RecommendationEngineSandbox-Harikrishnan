...
## Features
- **Preference/Weight Sliders:** Adjust ranking signals (Relevance, Recency, Price Sensitivity, Engagement bias) in real-time.
- **Model Score/Ranking Matrix View:** Inspectable scoring table demonstrating the underlying algorithmic math.
- **Bias Feedback Loop Demo:** Visualizes how dial adjustments alter content outcomes and platform influence.
